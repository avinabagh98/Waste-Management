...
export default function HouseholdScanPage() {
  ...
  const handleSubmitQR = (event) => {
    ...
    console.log("Submitted Form data ::", formDataQR);
    if (
      isLock === "0" &&
      (wasteGiven === "9" || wasteGivenSegregated === "9")
    ) {
      swal("Warning", "Please select all options", "warning");
    } else {
      try {
        axios
          .post("https://waste.ebluesys.com/api/qrsurvey/add", formDataQR)
          .then((response) => {
  ...
  return (
    <>
      ...
      <div className={styles.text}>
        <Textparser text={"Household Scan"} />
      </div>
            ...
            {isLock === "0" ? (
              <>
                <div className={styles.radioInput}>
                  <span className={styles.textWaste}>
                    {" "}
                    <Textparser text={"Wasten Given"} />
                  </span>
                ...
                <div className={styles.radioInput}>
                  <span className={styles.textWaste}>
                    {" "}
                    <Textparser text={"Wasten Given in Segregated Manner"} />
                  </span>
                  <div className={styles.radioInput_Options}>
                    <span>
                      <input
